            ...
            <form onSubmit={onSubmit} className='bg-white/[0.21] px-16 py-10 rounded-2xl'>
              ...
              <div className="relative mb-4 text-white">
                ...
                <input
                  ...
                  name="name"
                  className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out " placeholder="Name"
                />
              </div>
